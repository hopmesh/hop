...
export const cases = [
  {
    ...
    uses: [['hdp://', '/docs/hdp/'], ['spray-and-wait', '/docs/hdp/'], ['mailbox', '/docs/hdp/']],
  },
  {
    ...
    uses: [['anti-entropy', '/docs/streams/'], ['hps://', '/docs/hps/'], ['hdp://', '/docs/hdp/']],
  },
  {
    ...
    uses: [['carrier transport', '/docs/streams/'], ['hdp://', '/docs/hdp/']],
  },
  {
    ...
    uses: [['hops://', '/docs/hops/'], ['HNS', '/docs/hns/'], ['internet egress', '/docs/hops/']],
  },
  {
    ...
    uses: [['hps://', '/docs/hps/'], ['hdp://', '/docs/hdp/'], ['cloud backbone', '/docs/tcp/']],
  },
];
