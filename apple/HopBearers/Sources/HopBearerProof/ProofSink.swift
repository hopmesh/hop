// ProofSink — the clean-room "proof of pipe" consumer, shared by BOTH clean-room hosts (macOS CLI
// blepeer + iOS app). It is a `LinkSink`: the transport (a BearerManager over one or more bearers)
...
//
// It depends on HopBearerCore ONLY — nothing BLE-specific. Because links can now arrive from several
...
public final class ProofSink: LinkSink {
    /// The BearerManager (a Bearer); weak — the host owns it. Typed `Bearer`, not a concrete bearer:
