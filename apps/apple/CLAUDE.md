...
- **Build the driver's binary artifacts first:** `apple/build-xcframework.sh` (produces the gitignored libhop xcframework + Swift bindings that HopDriver links). CI does this before the app build.
