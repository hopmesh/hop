...
data "google_secret_manager_secret_version" "billing_price_ids" {
...
locals {
  ...
  billing_prices         = jsondecode(data.google_secret_manager_secret_version.billing_price_ids.secret_data)
