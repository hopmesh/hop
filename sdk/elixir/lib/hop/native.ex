defmodule Hop.Native do
  ...
  def open(_db_path, _secret, _app_secret), do: err()
  def open_keyed(_db_path, _secret, _app_secret, _key), do: err()
  def open_persistent(_db_path, _secret, _app_secret), do: err()
  def open_persistent_keyed(_db_path, _secret, _app_secret, _key), do: err()
  def is_persistent(_node), do: err()
  ...
  def cluster_mark_done(_node, _from, _request_id), do: err()
  def cluster_would_drop(_node, _from, _request_id), do: err()
  ...
  def accept_service_request(_node, _request_id), do: err()
  def reject_service_request(_node, _request_id), do: err()
  def is_encrypted(_node), do: err()
