...
module Hop
  ...
  class Endpoint
    ...
    def relay_add(url, configured = true) = with_node { |n| Hop::FFI.relay_add(n, url, configured) }
    ...
    def relay_next = with_node { |n| Hop::FFI.relay_next(n) }
