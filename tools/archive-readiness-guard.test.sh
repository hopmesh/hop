...
#   7. Rejects executable clone even when followed by a safety phrase on the same line.
#   8. Rejects a package manifest repository field pointing to hopmesh/monorepo.
#   9. Rejects a future-tag builder authorizing hopmesh/monorepo.
#  10. Accepts the legacy v0.0.1 trust anchor.
#  11. Accepts the legacy v0.0.2 trust anchor.
#  12. Rejects unallowlisted files referencing hopmesh/monorepo.
#  13. Passes on the clean repository tree.
...
# --- Test 8: Reject executable clone followed by safety phrase on the same line ---
...
# --- Test 9: Reject package repository field in package.json ---
...
# --- Test 10: Reject future-tag builder ---
...
# --- Test 11: Accept legacy v0.0.1 trust anchor ---
...
# --- Test 12: Accept legacy v0.0.2 trust anchor ---
...
# --- Test 13: Reject unallowlisted file containing reference ---
