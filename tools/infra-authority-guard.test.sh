...
expect("catalog Stripe reader cannot broaden", lambda r: mutate_block(r, "infra/bootstrap/billing.tf", "google_secret_manager_secret_iam_member", "billing_catalog_stripe_catalog_api_key_reader", 'role      = "roles/secretmanager.secretAccessor"', 'role      = "roles/secretmanager.admin"'))
expect("catalog Stripe reader cannot point to runtime key", lambda r: mutate_block(r, "infra/bootstrap/billing.tf", "google_secret_manager_secret_iam_member", "billing_catalog_stripe_catalog_api_key_reader", "google_secret_manager_secret.stripe_catalog_api_key.secret_id", "google_secret_manager_secret.stripe_api_key.secret_id"))
expect("catalog Resend reader cannot point to runtime key", lambda r: mutate_block(r, "infra/bootstrap/billing.tf", "google_secret_manager_secret_iam_member", "billing_catalog_resend_catalog_api_key_reader", "google_secret_manager_secret.resend_catalog_api_key.secret_id", '"hop-resend-apikey"'))
expect("catalog Stripe secret container cannot be destroyed", lambda r: mutate_block(r, "infra/bootstrap/billing.tf", "google_secret_manager_secret", "stripe_catalog_api_key", "prevent_destroy = true", "prevent_destroy = false"))
expect("catalog Resend secret container cannot be destroyed", lambda r: mutate_block(r, "infra/bootstrap/billing.tf", "google_secret_manager_secret", "resend_catalog_api_key", "prevent_destroy = true", "prevent_destroy = false"))
